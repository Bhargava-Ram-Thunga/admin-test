...
export const ProtectedLayout = () => {
    ...
    if (isLoading) {
        return <div className="min-h-screen flex items-center justify-center text-[#393D7E]">Loading...</div>;
    }
        ...
        <div className="flex h-screen bg-[#F5F7FA] font-sans text-slate-800">
            ...
            <main className="flex-1 overflow-y-auto p-4 lg:p-8 lg:ml-20">
                <header className="flex justify-between items-center mb-8">
                    <div>
                        <h2 className="text-2xl font-bold text-[#393D7E]">Welcome, {user.name}</h2>
