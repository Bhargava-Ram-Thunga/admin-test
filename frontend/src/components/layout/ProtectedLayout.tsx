...
export const ProtectedLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-[#F0F7FF] font-sans text-slate-800">
      <Sidebar user={user} />
      <main className="flex-1 overflow-y-auto p-4 lg:p-6 lg:ml-20">
        <header className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-2xl font-bold text-[#4D2B8C]">
              Welcome, {user.name}
            </h2>
            <p className="text-[#4D2B8C]/70 text-sm">{user.role}</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            <img
              ...
              className="w-10 h-10 rounded-xl border-2 border-[#4D2B8C]"
              alt="Profile"
            />
          </div>
        </header>
