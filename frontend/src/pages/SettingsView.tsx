    ...
    <Card>
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="space-y-4 flex-1">
          ...
          <button className="bg-[#4D2B8C] text-white px-6 py-2 rounded-xl text-sm font-bold hover:bg-[#F39EB6] transition">
            Save Changes
          </button>
        </div>
      </div>
    ...
    <Card>
      ...
      <div className="bg-[#F5F7FA] p-6 rounded-2xl flex flex-col md:flex-row gap-4 items-end">
        ...
        <div className="w-full md:w-48">
          ...
          <select className="w-full mt-1 p-3 bg-white border border-[#4D2B8C]/10 rounded-xl outline-none text-[#4D2B8C]">
